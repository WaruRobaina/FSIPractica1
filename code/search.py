...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print ("Nodos visitados: " + str(counter + 1))
            print ("Nodos expandidos: " + str(counter))
            return node
...
def search_ramification(problem):
    """Ordena por el coste total acumulado"""
    return graph_search(problem, ramification())

def search_ramification_understimated(problem):
    """Ordena por el coste total acumulado y la heurística"""
    return graph_search(problem, ramification_understimated(problem))
